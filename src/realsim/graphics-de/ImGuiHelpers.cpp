...
namespace RSim::Graphics
{
	...
	std::unique_ptr<Diligent::ImGuiImplDiligent> InitializeDiligentImGuiImpl(Core::Window* pWindow, Diligent::IRenderDevice* pDevice,
		Diligent::TEXTURE_FORMAT BackBufferFmt, Diligent::TEXTURE_FORMAT DepthBufferFmt)
	{
		IMGUI_CHECKVERSION();
